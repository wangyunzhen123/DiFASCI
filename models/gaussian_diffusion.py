...
class GaussianDiffusion:
    ...
    def training_losses_distill(
            self, model, teacher_model, first_stage_model, x, y, meas, input_setting, input_mask, loss_type, t, device, model_kwargs, noise=None
            ):
        """
        ...
        terms = {}
        assert loss_type in ["MC","EC", "DISTILL"]
        terms["loss"] = 0
        ...
        if True:
            ...
            if loss_type == "DISTILL":
                ...
                x_diff_rgb = torch.clamp(x_diff_rgb, 0.0, 1.0)
                x_refined_rgb = x_1[:, [25, 13, 7], :, :]
